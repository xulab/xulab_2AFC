...
const char animalName[] = "cll09";

// Trial settings
const char stimType[] = "noise"; // "noise";// "pureTone";//"sweep";
const int maxNumTrials = 800;
const int maxSameSides =3;
const int leftProb = 50;
//const int waterValveDuration = 25; // 100 ms
const int leftWaterValveDuration =  27;
...
const uint16_t allToneFreq[2] = {8000, 10000}; //{1000, 4000};//
byte vol[2] = {150, 150};
...
const int fq_sweep[2] = {6000, 18000};
