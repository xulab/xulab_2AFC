...
const char animalName[] = "your_mouse";
// Trial type Settings
...
// Reward parameters
const int leftWaterValveDuration =  50;
...
// Timing parameters
const int answerPeriod = 500; // time when response can be accepted after stimulus.
...
const int interTrialInterval = 500;
...
const uint16_t fq_pureTone[2] = {10000, 13300};//{16000, 22000}; //
