...
const char animalName[] = "cll03";

// Trial settings
const char stimType[] = "sweep"; // "noise";// "pureTone";//"sweep";
...
const int rightWaterValveDuration = 15;
...
const uint16_t allToneFreq[2] = {12000, 20000}; //{1000, 4000};//
byte vol[2] = {170, 170};

// Edge frequncy for bandpass noise or sweeps
const int  fq_lo[2] ={6000,12000}; 
const int  fq_hi[2] ={12000,16000};

const int fq_sweep[2] = {6000, 12000};
...
int stimulusDelivery(int sides) {
  ...
  if (strcmp(stimType, "pureTone") == 0)
  {
      ...
      SPI_TGM.quick_tone_vol_cosramp_5ms(stimDur, toneFreq, vol[sides]);
