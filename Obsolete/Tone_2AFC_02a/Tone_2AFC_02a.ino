...
#define StimOutPinLeft 6
#define StimOutPinRight 7
...
*/
  ...
  pinMode(LED, OUTPUT);
  pinMode(StimOutPinLeft, OUTPUT);
  pinMode(StimOutPinRight, OUTPUT);
  ...
  digitalWrite(StimOutPinLeft, LOW);
  digitalWrite(StimOutPinRight, LOW);
...
int stimulusDelivery(int sides) {
  ...
  if (sides == 0) { // right trial
    ...
    digitalWrite(StimOutPinLeft, HIGH);
    delay(duration);
    digitalWrite(StimOutPinLeft, LOW);
    //    delay(duration);
  }
  ...
  if (sides == 1) { // right trial
    //    digitalWrite(LED, HIGH);
    digitalWrite(StimOutPinRight, HIGH);
    delay(duration);
    digitalWrite(StimOutPinRight, LOW);
    //    delay(duration);
    //    digitalWrite(LED, LOW);
