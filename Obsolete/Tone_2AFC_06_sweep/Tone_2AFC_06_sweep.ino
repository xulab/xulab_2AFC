...
const int  fq0[2] ={6000,12000};
const int  fq1[2] ={8000,16000};
byte vol_left = 170; // Roughly 65 db on average.
byte vol_right = 170; 
...
void print_settings() {
  ...
  Serial.print("vol_left = ");
  Serial.println(vol_left);
  Serial.print("vol_right = ");
  Serial.println(vol_right);
  
  Serial.print("toneFreq (L, R) = ");
 

   Serial.print(fq0[0]);Serial.print("\t"); 
    Serial.print(fq1[0]);Serial.print(":"); 
     Serial.print(fq0[1]);Serial.print("\t"); 
    Serial.println(fq1[1]);
  Serial.println("###################");
}
...
int stimulusDelivery(int sides) {
     ...
     //SPI_TGM.quick_noise_cosramp_5ms(stimDur,  fq0[0],  fq1[0],  vol_left, SWEEP_NOISE_WHITE);
     SPI_TGM.quick_sweep_linear_cosramp_5ms(stimDur, fq0[0], fq1[0], vol_left);
    // tone(StimOutPin, toneFreq[0], stimDur);
    Serial.print("\nTone Freq--------------: ");
    Serial.print(fq0[0]);Serial.print("\t"); 
    Serial.println(fq1[0]);
}
   
  

  if (sides == 1) { // right trial
     //SPI_TGM.quick_noise_cosramp_5ms(stimDur,  fq0[1],  fq1[1],  vol_right, SWEEP_NOISE_WHITE);
    SPI_TGM.quick_sweep_linear_cosramp_5ms(stimDur, fq0[1], fq1[1], vol_right);
    Serial.print("\nTone Freq--------------: ");
    Serial.print(fq0[1]);Serial.print("\t"); 
    Serial.println(fq1[1]);
}
  ...
  // SPI_TGM.quick_noise_cosramp_5ms(stimDur,  fq0[sides],  fq1[sides],  vol, SWEEP_NOISE_WHITE);
