...
// Reward parameters
const int leftWaterValveDuration = 25; // 100 ms
...
int stimulusDelivery(int sides) {
  if (sides == 0) { // right trial
    SPI_TGM.quick_tone_vol_cosramp_5ms(stimDur, toneFreq, 192 - soundAtt);
