...
//const uint16_t allToneFreq[2] = {10000, 20000}; //{1000, 4000};//
const uint16_t leftFreq[3] = {6000, 7000, 8000};
const uint16_t rightFreq[3] = {12000, 14000,16000};
...
void print_settings() {
  ...
  Serial.print(leftFreq[0]); Serial.print("\t"); 
  Serial.print(leftFreq[1]);Serial.print("\t"); 
  Serial.print(leftFreq[2]); Serial.print(","); Serial.print("\t"); 
  Serial.print(rightFreq[0]);Serial.print("\t"); 
  Serial.print(rightFreq[1]);Serial.print("\t"); 
  Serial.println(rightFreq[2]);
  Serial.println("###################");
...
int stimulusDelivery(int sides) {
  ...
  int FQ_side[] ={10000,20000};
  FQ_side[0]  = leftFreq[random(0,3)];
  FQ_side[1]  = rightFreq[random(0,3)];

  toneFreq =FQ_side[sides];
...
void flash_rightLed() {
 ...
 void sendOutResults() {
  ...
  trialResultsStr += String("pureTone");
  trialResultsStr += "/toneFreq=";
  trialResultsStr += String(toneFreq);
  trialResultsStr += "/toneIntensity=";
  trialResultsStr += String(SPL_in_DB);
  trialResultsStr += "/setVolume=";
  trialResultsStr += String(toneVolume);
  // events times
  ...
  // animal responses
  trialResultsStr += "/numLickLeft=";
  trialResultsStr += String(lickCountLeft);
  trialResultsStr += "/numLickRight=";
  trialResultsStr += String(lickCountRight);
