...
// Rig and animal ID
const char rig_name[] = "rig11";
const char animalName[] = "z01";
// Trial type Settings
...
const int post_cue_stim_delay = 500; // delay time after cue and before stimulus
...
const int fq_pureTone_probe[2] ={11500, 18400};
...
const int rightWaterValveDuration = 33;
const byte LEFT = 0;
const byte RIGHT = 1;
const byte MISS = 2;
