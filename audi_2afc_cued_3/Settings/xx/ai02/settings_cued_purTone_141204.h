...
char stimType[] = "pureTone"; // "noise";// "pureTone";//"sweep";//randompureTone;//"peak";//
// Cue parameters
...
const int rightWaterValveDuration = 22;
const byte LEFT = 0;
const byte RIGHT = 1;
const byte MISS = 2;
...
const int ExtraITIDur =6000; // this should be 0 if there are probe trials.
