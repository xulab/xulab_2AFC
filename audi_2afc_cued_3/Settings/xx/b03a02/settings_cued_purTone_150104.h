...
// Rig and animal ID
const char rig_name[] = "rig04";
const char animalName[] = "b03a02";
// Trial type Settings
const int maxNumTrials = 600;
...
char stimType[] = "randompureTone"; // "noise";// "pureTone";//"sweep";//randompureTone;//"peak";//
// Cue parameters
...
const int ExtraITIDur =3000; // this should be 0 if there are probe trials.
...
const int ranTone_left[3] = {8000,10556,13929};
const int ranTone_right[3] = {18379,24251,32000};
...
const int fq_peak[6] = {10000,5000,10000,10000,15000,10000};

const int errorLedDur = 15; 
